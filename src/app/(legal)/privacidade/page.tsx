    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          Railway e Neon (hospedagem e banco de dados) e Cloudflare (entrega e proteção do site).
      ...
      <section>
        ...
        <p>
          ...
          conhecer o armazenamento usado pelo site. Caso passemos a usar novas ferramentas
          de análise de navegação, atualizaremos esta política para descrever os dados
          efetivamente coletados. Alterações relevantes serão comunicadas pelos canais disponíveis.
        </p>
      </section>
    </>
  );
